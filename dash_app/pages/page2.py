...
with open("edge_betweenness_dataframes.json", 'r') as infile:
...
layout = html.Div([
    ...
    html.Div([
        ...
        html.P(
            ...
            Examining the most common keywords and the polarization level within communities who tweet about these keywords, we can better understand the state of political discourse.""", className='lead', style={"marginTop": "40px", "fontSize": "20px", "textAlign": "justify", "textJustify": "inter-word"}),
