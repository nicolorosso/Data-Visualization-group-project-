...
layout = html.Div([
    ...
    html.Br(),
    html.Br(),
    html.H1('Top 10 Community Network Graphs', style={'textAlign': 'center'}),
    html.Div([
        html.P(
            """
            ...
            """, className='lead', style={"marginTop": "40px", "fontSize": "20px", "textAlign": "justify", "textJustify": "inter-word"}
